...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/myinfo_like.css">
...
<body>
	...
	<div class="content clf myinfoContent">
		...
		<div class="sizeLimit myinfoArea clf">
			<div class="listWrap">
				<ul>
					<c:forEach var="i" items="${furnitureList}">
					<li>
						<a href="${pageContext.request.contextPath}/search/detail?furId=${i._id}">
							<img src="${i.furImage}" alt="">
							<p class="likeArea"><i class="fas fa-heart"></i></p>
						</a>
					</li>
					</c:forEach>
				</ul>
